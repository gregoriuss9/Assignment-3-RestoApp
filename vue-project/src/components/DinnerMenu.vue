                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <div class="col-sm-2">
                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click.prevent="$event => raw_data.addMenu(raw_data.data1,'dinner')">Save changes</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <div class="col-sm-2">
                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="$event => raw_data.editMenu(raw_data.data1,'dinner', raw_data.bookingID) ">Save changes</button>
                                </div>
                            </div>
                        </div>
                    </div>
